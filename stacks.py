...
new_wavs = np.arange(2400, 4200,5) #new wavelength grid
...
for m in range(len(new_wavs)):
    ...
    #errs[m] = np.median(spec_errs) defo no
...
ax1.plot(new_wavs, median_spec*10**18, color="black", lw=1.5, )
#ax2.plot(new_wavs, errs*10**18, color="red", lw=1.5)
